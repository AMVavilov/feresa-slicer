...
data class SlicerSettings(
    ...
    val infillDensityPercent: Double = 20.0,
    val infillAngleDegrees: Double = 45.0,
    val infillSpeedMmS: Double = 100.0,
...
object NativeSlicer {
    ...
    fun sliceModel(
        ...
        val fields = slice(
            ...
            infillDensity = settings.infillDensityPercent,
            infillAngle = settings.infillAngleDegrees,
            infillSpeed = settings.infillSpeedMmS,
